...
namespace OsmSharpDataProcessor.Streams
{
    ...
    public class CHEdgeFlatfileStreamTarget : OsmSharp.Routing.Osm.Streams.Graphs.CHEdgeGraphOsmStreamTarget
    {
        ...
        public CHEdgeFlatfileStreamTarget(ITagsCollectionIndex tagsIndex, Vehicle vehicle)
        ...
        /// </summary>
        /// <returns></returns>
        public static CHEdgeFlatfileStreamTarget CreateTarget(Vehicle vehicle)
        {
            return new CHEdgeFlatfileStreamTarget(new TagsTableCollectionIndex(), vehicle);
        }
    }
}
