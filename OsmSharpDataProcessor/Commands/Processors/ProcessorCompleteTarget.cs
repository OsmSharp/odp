...
{
    /// <summary>
    /// Represents a processor that encapsulates a complete target.
    /// </summary>
    public class ProcessorCompleteTarget : ProcessorBase
    {
        /// <summary>
        /// Holds the stream target.
        /// </summary>
        private OsmCompleteStreamTarget _target;
        ...
        public ProcessorCompleteTarget(OsmCompleteStreamTarget target)
        {
            _isReady = false;
            _target = target;
        }
