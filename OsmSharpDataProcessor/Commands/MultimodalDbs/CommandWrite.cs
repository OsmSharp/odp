...
namespace OsmSharpDataProcessor.Commands.MultimodalDbs
{
    ...
    public class CommandWrite : Command
    {
        ...
        /// <summary>
        /// Parse the command arguments for the write-multimodaldb command.
        /// </summary>
        public override int Parse(string[] args, int idx, out Command command)
        {
            ...
            if (args.Length < idx)
            {
                throw new CommandLineParserException("None", "Invalid file name for write-multimodaldb command!");
            }
        ...
        {
            return new Processors.MultimodalDbs.ProcessorWrite(this.File);
        }
        ...
        {
            return string.Format("--write-multimodaldb {0}", this.File);
        }
    }
}
